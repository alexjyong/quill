...
If you are looking for a reference on _what_ Deltas are, the [Delta documentation](/docs/delta/) is a more concise resource.
...
- <code>text: "Hello&nbsp;&nbsp;World"</code> unambiguously means there are precisely
